...
public class ThreadsExercise9 {
	/*
	 * Modify Threads/cp/ConcurrentMap to compute a map of type Map<Character, Set<String>>. The map
	 * should map a character to the set of words that start with that character (case sensitive).
	 */
